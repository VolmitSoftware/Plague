...
public class PlagueCommandParameter
{
	...
	public Object fitDefault()
	{
		...
		{
			return Integer.valueOf(getOptional().defaultInt());
		}

		if(getType().equals(Float.class))
		{
			return Float.valueOf(getOptional().defaultFloat());
		}

		if(getType().equals(Double.class))
		{
			return Double.valueOf(getOptional().defaultDouble());
		}

		if(getType().equals(Long.class))
		{
			return Long.valueOf(getOptional().defaultLong());
		}

		if(getType().equals(Boolean.class))
		{
			return Boolean.valueOf(getOptional().defaultBoolean());
		}
